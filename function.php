...
function simone_scripts() {
	...
	wp_enqueue_style( 'simone-google-fonts',  get_theme_file_uri( 'fonts.css' ), array(), wp_get_theme()->get( 'Version' ) );
...
/**
 *  Add fonts for the block editor.
 */
function simone_block_editor_assets() {
	wp_enqueue_style( 'simone-google-fonts-editor',  get_theme_file_uri( 'fonts.css' ), array(), wp_get_theme()->get( 'Version' ) );
	wp_enqueue_style( 'simone-block-editor-styles',  get_theme_file_uri( 'inc/block-editor-style.css' ), array(), wp_get_theme()->get( 'Version' ) );
}
add_action( 'enqueue_block_editor_assets', 'simone_block_editor_assets' );
...
function fumax_enqueue_scripts() {
    wp_enqueue_style( 'custom-style', get_stylesheet_directory_uri() . '/custom.css' );
}
add_action( 'wp_enqueue_scripts', 'fumax_enqueue_scripts' );
